...
.about, .projects, .skills, .certificates, .contact, footer{
...
.about .about-content .right a{
    ...
    margin-top: 20px;
    border-radius: 6px;
    border: 2px solid rgb(204, 134, 4);
    transition: all 0.3s ease;
}
...
.certificates .carousel .card .box{
    display: flex;
...
.certificates .carousel .card:hover .box{
    transform: scale(1.05);
}
.certificates .carousel .card .text{
    font-size: 25px;
    font-weight: 500;
    margin: 10px 0 7px 0;
}
.certificates .carousel .card img{
    ...
    object-fit: cover;
    border-radius: 50%;
    border: 5px solid rgb(204, 134, 4);
    transition: all 0.3s ease;
}
.certificates .carousel .card:hover img{
    border-color: #ca2e43;
}
.owl-dots{
    text-align: center;
...
.owl-dot{
    ...
    border-radius: 50%;
    border: 2px solid rgb(9, 236, 138)!important;
    transition: all 0.3s ease;
}
.owl-dot.active{
    width: 35px;
...
.owl-dot.active,
.owl-dot:hover{
    background: rgb(204, 134, 4)!important;
}
